      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Welcome to <span className="text-blue-600">DP Electricals</span>
            </motion.h2>
            <motion.div
              initial={{ width: 0 }}
              ...
              className="h-1 bg-gradient-to-r from-blue-500 to-indigo-600 mx-auto rounded-full mb-8"
            ></motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-medium py-2 px-6 rounded-lg"
              >
                Learn More
              </motion.button>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Our <span className="text-blue-300">Vision</span></h2>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 mt-12">Our <span className="text-blue-300">Mission</span></h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg"
          >
            Get in Touch
          </motion.button>
        </div>
